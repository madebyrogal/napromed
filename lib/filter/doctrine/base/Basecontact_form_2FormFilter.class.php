...
/**
 * contact_form_2 filter form base class.
 *
 * @package    tnt
 * @subpackage filter
 ...
 */
abstract class Basecontact_form_2FormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('contact_form_2_filters[%s]');
