...
abstract class BaseproductForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'promotion'   => new sfWidgetFormInputCheckbox(),
    ...
    $this->setValidators(array(
      ...
      'promotion'   => new sfValidatorBoolean(array('required' => false)),
      'hidden'      => new sfValidatorBoolean(array('required' => false)),
      'position'    => new sfValidatorInteger(array('required' => false)),
    ));

    $this->validatorSchema->setPostValidator(
      new sfValidatorDoctrineUnique(array('model' => 'product', 'column' => array('position', 'category_id')))
    );
