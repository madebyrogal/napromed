...
/**
 * Sprawdza czy jest zainstalowany moduł
 * @param string $moduleName Nazwa modułu
 * @return boolean true jeżeli moduł jest zainstalowany
 */
function checkApacheModule($moduleName) {
...
check(checkApacheModule('mod_rewrite'), 'Rewrite module is on', 'Set it to on in apache configuration (httpd.conf)', false);
