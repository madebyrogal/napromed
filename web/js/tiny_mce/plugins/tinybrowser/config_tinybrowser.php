...
define('IMG_PATH', '/useruploads/images/');
define('MEDIA_PATH', '/useruploads/media/');
define('FILE_PATH', '/useruploads/files/');
...
$tinybrowser['obfuscate'] = 's0merand0mjunk!!!8313';
...
if(preg_match('#.*localhost.*#', $_SERVER['HTTP_HOST'])){
    $tinybrowser['path']['image'] = LOCAL_HOST_PATH.IMG_PATH; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
    $tinybrowser['path']['media'] = LOCAL_HOST_PATH.MEDIA_PATH; // Media files location
    $tinybrowser['path']['file']  = LOCAL_HOST_PATH.FILE_PATH; // Other files location
}
else{
    $tinybrowser['path']['image'] = IMG_PATH;; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
    $tinybrowser['path']['media'] = MEDIA_PATH; // Media files location
...
$tinybrowser['link']['image'] = ''.IMG_PATH; // Image links
$tinybrowser['link']['media'] = ''.MEDIA_PATH; // Media links
$tinybrowser['link']['file']  = ''.FILE_PATH; // Other file links
...
$tinybrowser['filetype']['media'] = '*.ogg, *.m2v, *.flv, *.swf, *.dcr, *.mov, *.qt, *.mpg, *.mp3, *.mp4, *.mpeg, *.avi, *.wmv, *.wm, *.asf, *.asx, *.wmx, *.wvx, *.rm, *.ra, *.ram'; // Media file types
